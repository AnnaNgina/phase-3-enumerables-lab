...
def print_spicy_foods(spicy_foods)
  ...
  the_heatlevel = ":hot_pepper:"*food[:heat_level]
  puts "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{the_heatlevel}"
  end
end
...
def print_spiciest_foods(spicy_foods)
  ...
  the_heatlevel = ':hot_pepper:' * foods[:heat_level]
  puts "#{foods[:name]} (#{foods[:cuisine]}) | Heat Level: #{the_heatlevel}"
  end
end
